var app = {
    init: function (artistData) {
        ...
        this.setupInventory(artistData);
        this.setupPlaylist();
        this.setupUpload();
        this.changeFontSize();
    ...
    setupInventory: function (artistData) {
        var me = this;
        var artistData = artistData || false;
        ...
        if (artistData) {
            this.dsArtists = new YAHOO.util.DataSource(artistData);
        } else {
            this.dsArtists = new YAHOO.util.DataSource(this.getPath('inventory'));
        }
    ...
    rebuildPlaylist: function (val, cb) {
        ...
        $.get(this.getPath('search'), {q: val}, function (data) {
    ...
    loadAlbumArt: function (hash) {
        ...
        //return;
        $('#player-holder .cover').css({backgroundImage: 'url(' + this.getPath('art/' + hash) + ')'});
    },
